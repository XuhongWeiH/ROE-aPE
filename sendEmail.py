...
if __name__ == "__main__":
    ...
    sh.600755,厦门国贸,商业贸易,申万一级行业
    sh.601288,农业银行,银行,申万一级行业
    sh.600585,海螺水泥,建筑材料,申万一级行业
    sh.601398,工商银行,银行,申万一级行业
    sh.601939,建设银行,银行,申万一级行业
    sh.600048,保利地产,房地产,申万一级行业
    sz.000001,平安银行,银行,申万一级行业
    sz.000338,潍柴动力,汽车,申万一级行业
    sz.000921,海信家电,家用电器,申万一级行业
    sh.600660,福耀玻璃,汽车,申万一级行业
    '''
    # outStr += "注意事项：\n \
