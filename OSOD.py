...
class oneStockDocument:
    ...
    def readPE(self):                     
        df_origin_PE = get_bao_PE_byCode( code = self.code, sltDateBegin='2008-01-01', sltDateEnd='2019-04-30')
    ...
    def readK_line(self):
        df_origin_Kline = askPrice_byDate( code = self.code, sltDateBegin='2008-01-01', sltDateEnd='2019-04-30')
